...
export default function About() {
  ...
  const fetchStats = async () => {
    try {
      ...
      if (projects && projects > 0) setProjectCount(projects);
      if (certificates && certificates > 0) setCertificateCount(certificates);
    } catch {
        ...
        >
          ...
          >
            ...
            >
              {/* DOWNLOAD CV */}
              <a
                href="/assets/CV%20CINDY.pdf"
                target="_blank"
                rel="noopener noreferrer"
                download="CV_Cindy_Anggraeni.pdf"
